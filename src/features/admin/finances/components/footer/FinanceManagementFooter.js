/*FinanceManagementFooter.js*/
import React from "react";
import '../../../shared/components/footer/ManagementFooter.css';

const FinanceManagementFooter = ({ currentPage, totalPages, onPageChange }) => {
    return (
...
export default FinanceManagementFooter;
