...
import useUpdateVacationModal from '../../hooks/useUpdateVacationModal';
...
const UpdateVacationModal = ({ handleClose, selectedVacation }) => {
    const {
        ...
        setShowWarningModal,
        handleSubmit
    } = useUpdateVacationModal(selectedVacation, handleClose);
                ...
                <form onSubmit={handleSubmit}>
                    <div className="custom-modal-body">
                        ...
                        <input
                            ...
                            required
                        />
                        <label className="custom-modal-body-content-label">휴가 종류</label>
                        <select
                            value={vacationType}
                        ...
                        <input
                            ...
                            required
                        />
                        <label className="custom-modal-body-content-label">종료일:</label>
                        <input
                            type="date"
                            ...
                            required
                        />
                        <label className="custom-modal-body-content-label">사유:</label>
                        <textarea
                            value={urgentReason}
